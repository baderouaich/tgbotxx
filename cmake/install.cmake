...
# Define export set and associate it with the targets we want to export (cpr & nlohmann_json)
install(TARGETS tgbotxx cpr nlohmann_json
...
install(
        FILES
        ${CMAKE_SOURCE_DIR}/cmake/find-or-fetch.cmake
        ${CMAKE_SOURCE_DIR}/cmake/tgbotxx-config.cmake
        ${CMAKE_SOURCE_DIR}/cmake/tgbotxx-dependencies.cmake
